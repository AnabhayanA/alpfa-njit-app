      ...
      <Svg width={size} height={size} viewBox="0 0 500 500" style={StyleSheet.absoluteFill}>
        <Defs>
          <ClipPath id="alpfa-left-reveal">
            <AnimatedRect x="120" y="40" progress={progress} inputRange={[0, 0.68, 1]} outputRange={[0, 230, 230]} height="245" />
          </ClipPath>
          <ClipPath id="alpfa-right-reveal">
            <AnimatedRect x="245" y="40" progress={progress} inputRange={[0, 0.28, 1]} outputRange={[0, 0, 115]} height="245" />
          </ClipPath>
        </Defs>
