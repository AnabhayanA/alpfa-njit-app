  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity activeOpacity={0.92} style={[styles.featuredCard, { marginTop: responsive.responsiveSpacing.lg, padding: responsive.isSmallPhone ? 18 : 22 }]} onPress={goToEvents}>
...
const createStyles = (colors: ThemePalette) => StyleSheet.create({
  ...
  section: { marginTop: 26 }, rowBetween: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', gap: 12 }, sectionTitle: { color: colors.textPrimary, fontSize: 24, fontWeight: '900' }, sectionCaption: { color: colors.textSecondary, fontSize: 11, marginTop: 4 }, seeAll: { color: '#6E1B2D', fontSize: 12, fontWeight: '800', flexShrink: 1, textAlign: 'right' }, actionsGrid: { width: '100%', alignSelf: 'stretch', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'flex-start', marginTop: 14 },
  actionTile: { width: '50%', marginBottom: 8 }, actionCard: { width: '100%', minHeight: 130, padding: 14, borderRadius: 16, justifyContent: 'space-between', shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 9, shadowOffset: { width: 0, height: 5 } }, burgundy: { backgroundColor: '#6E1B2D' }, navy: { backgroundColor: '#0F102E' }, light: { backgroundColor: colors.surface }, actionIcon: { width: 38, height: 38, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.12)', alignItems: 'center', justifyContent: 'center' }, actionIconLight: { backgroundColor: colors.iconBgLight }, actionTitle: { color: '#FFFFFF', fontSize: 16, fontWeight: '800', marginTop: 10, flexShrink: 1 }, darkText: { color: colors.textPrimary }, actionSubtitle: { color: 'rgba(255,255,255,0.75)', fontSize: 10, marginTop: 3, flexShrink: 1 }, darkSubtext: { color: colors.textSecondary }, actionArrow: { alignSelf: 'flex-end', marginTop: 8 },
