      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        <Animated.View style={[styles.header, { opacity: fade, transform: [{ translateY: slide }] }]}>
          <View style={styles.headerTop}>
            <View style={styles.headerText}>
              ...
              <Text style={styles.headerTitle}>ALPFA NJIT</Text>
              <Text style={styles.headerSubtitle}>Building Leaders. Creating Opportunities.</Text>
            </View>
          </View>
        </Animated.View>

        <TouchableOpacity activeOpacity={0.92} style={styles.featuredCard} onPress={goToEvents}>
          ...
          <Text style={styles.featuredTitle}>Your community.</Text>
          <Text style={styles.featuredTitleAccent}>Your opportunity.</Text>
          <Text style={styles.featuredText}>Connect with students, professionals, events, and opportunities through ALPFA NJIT.</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.actionsGrid}>
            <ActionCard icon="calendar" title="Events" subtitle="What's happening" type="burgundy" onPress={goToEvents} />
        ...
        <View style={styles.section}><Text style={styles.connectTitle}>Stay Connected</Text><Text style={styles.connectText}>Follow ALPFA NJIT and stay connected with everything happening in our community.</Text><View style={styles.socialRow}>
...
function ActionCard({ icon, title, subtitle, type, onPress }: { icon: keyof typeof Ionicons.glyphMap; title: string; subtitle: string; type: 'burgundy' | 'navy' | 'light'; onPress: () => void }) {
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#0F102E', paddingTop: 62, paddingHorizontal: 21, paddingBottom: 29 },
